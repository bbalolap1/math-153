...
1. A minimally guided symbolic function composition prompt with the method unstated.
2. A function composition representation bridge that changes notation or context while preserving the same first decision.
3. A cumulative function composition prompt with one prerequisite and the required final-form check.
