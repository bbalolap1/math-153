...
class CourseLesson:
    ...
    source_refs: tuple[str, ...] = ("MODEL-INFERENCE-PENDING-SOURCE-REVIEW",)
    common_mistakes: tuple[str, ...] = (
        "Choosing a rule from surface vocabulary instead of the mathematical structure.",
        "Skipping the check or requested answer form.",
    )
    connections: str = (
        "This lesson supplies prerequisites that reappear in later symbolic, contextual, and graph forms."
    )
